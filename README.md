...
Always use the latest version from this repo. If you need a format or size that isn't here, contact the tech team rather than modifying files yourself.

## Contributing

This repository is public. Do not upload anything that isn't meant to be publicly accessible. If you have new or updated assets to add, open a pull request or contact the tech team. Do not upload assets directly without review.
